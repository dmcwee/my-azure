...
```
Stop-MyAzureVMs [-ResourceGroupName] <String> [[-VMNameFilter] <String>] [[-TagName] <String>]
 [[-TagValue] <String>] [-Wait] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Stops all VMs in the provided Resouce Group. 
